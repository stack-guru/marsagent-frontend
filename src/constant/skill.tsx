...
import { SkillItemsProps } from "../types/skill";
...
const skills: SkillItemsProps["item"] = [
  {
    item: {
      label: "JavaScript",
      value: 100,

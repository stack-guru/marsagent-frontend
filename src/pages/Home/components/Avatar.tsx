...
import { FaLink, FaRobot, FaPlus } from "react-icons/fa";
  ...
  return (
    <div className="order-1 col-span-12 lg:order-2 lg:col-span-4">
      <div className=" relative">
        ...
        <div
          className="pulse bg-card absolute bottom-[-10px] right-[10px] flex items-center gap-[20px] rounded-full px-[40px] py-[18px] md:bottom-[-5px] lg:right-[-34px]"
          data-aos="fade-up"
        >
          {/* <div>
            <svg
          ...
          <div className="text-theme flex items-center gap-2">
            <FaRobot className="text-theme" size={28}/>
            <FaPlus className="text-white" size={12}/>
            <FaLink className="text-theme" size={28}/>
            {/* <div className="flex items-center gap-4">
              <FaRobot />
              <span className="text-white text-[18px] font-semibold">AI</span>
            </div>
            <div className="flex items-center gap-4">
              <FaLink />
              <span className="text-white text-[18px] font-semibold">Blockchain</span>
            </div> */}
          </div>
        </div>
      </div>
